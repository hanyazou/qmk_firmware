...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        LM(MODI, MOD_LCTL), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        MO(NAVI), LM(MODI, MOD_LGUI), LM(MODI, MOD_LALT), MO(LOWER), KC_SPC, /*    */ KC_BTN4, KC_WH_U, KC_WH_D, KC_ENT, /*    */ KC_HENK,  MO(RAISE), KC_RALT, MO(FUNC), LT(FUNC, KC_APP), KC_RCTL
    ),
    [DVORAK] = LAYOUT(
	...
	KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_LBRC, KC_RBRC, KC_BSLS,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_UP,   KC_LEFT, KC_RIGHT,KC_DOWN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC, /*    */ KC_SPC,  KC_SPC,  KC_LSFT,  KC_ENT, /*    */ KC_HENK,  KC_LSFT,  KC_RALT, KC_APP,  KC_RGUI, KC_RCTL
    ),
    /*
